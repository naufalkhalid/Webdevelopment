...
$(document).ready(function () {
    ...
    $.ajax({
        url: "LifeStyleAndConvenience.aspx/LoadCustomers",
        type: "POST",
        dataType: "json",
    ...
    function LoadStatus() {
        $.ajax({
            url: "LifeStyleAndConvenience.aspx/GetStatus",
            type: "POST",
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            data: "{}",
    ...
    function LoadCategories() {
        $.ajax({
            url: "LifeStyleAndConvenience.aspx/GetCategories",
            type: "POST",
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            data: "{}",
    ...
    $("#btnOpenManageCategories").click(function () {
        window.location.href = "../CategoriesManagement/ManageCategories.aspx?f=LC";
    });
    ...
    function ValidateRepairandServiceForm() {
        ...
        formserrep.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "LifeStyleAndConvenience.aspx/AddUpdateServiceRequest",
                    type: "POST",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
    ...
    $('#grdServiceandRepairs').on('click', '.EditServRepairs', function (e) {
        ...
        if ($("#HdnCustomerType").val().indexOf("Corporate") > -1) {///////////////////////////Corporate///////////////
            ...
            $.ajax({
                url: "LifeStyleAndConvenience.aspx/GetRepairRecord",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                data: "{'id':'" + trids + "'}",
    ...
    $("#btnSRDelYes").click(function () {
        ...
        if ($("#HdnCustomerType").val().indexOf("Corporate") > -1) {///////////////////////////Corporate///////////////
            ...
            $.ajax({
                url: "LifeStyleAndConvenience.aspx/DeleteRecord",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                data: "{'id':'" + id + "'}",
    ...
    function clear() {
        ...
        $("textarea").val("");
        $("select").val("");
        $("#LabelHeadingAddUpdateService").text("Add Request");
    ...
    $("#addComment").click(function () {
        if ($("#txtComments").val().length > 0) {
            ...
            $.ajax({
                url: "LifeStyleAndConvenience.aspx/AddComments",
                type: "POST",
                dataType: "json",
                contentType: "application/json; charset=utf-8",
            ...
            $("#msg_txt").text("Please Enter Comments");
            $("#success").modal("show");
        }
    });
    ...
    function OnViewComment() {
        ...
        var trid = $("#hdnRecordID").val();
        $.ajax({
            url: "LifeStyleAndConvenience.aspx/ViewComments",
            type: "POST",
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            data: "{'RecordId':'" + trid + "'}",
