...
$(document).ready(function () {
    ...
    function ValidateUserInfo() {
        ...
        formap.validate({
            ...
            submitHandler: function (form) {
                ...
                var clientid = $("#role :selected").val();
                ...
                if (password != confirmpassword) {
                    ...
                    $.ajax({
                        url: "AddClient.aspx/CreateUser",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        data: "{'role':'" + role + "','firstname':'" + firstname + "','lastname':'" + lastname + "','email':'" + email + "','phone':'" + phone + "','username':'" + username + "','password':'" + password + "','clientid':'" + clientid + "'}",
                        dataType: "json",
                        async: false,
    ...
    $('.make-switch').on('switchChange.bootstrapSwitch', function (event, state) {
        ...
        $.ajax({
            url: "AddClient.aspx/ActiveInactiveUser",
