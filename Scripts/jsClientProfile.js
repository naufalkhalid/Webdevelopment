...
$(document).ready(function () {
    ...
    function GetStatus() {
        ...
        $.ajax({
            url: "MainProfile.aspx/LoadStatus",
            type: "POST",
    ...
    function loadroles() {
        ...
        $.ajax({
            url: "MainProfile.aspx/LoadRoles",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            data: "{'CID':'" + CID + "'}",
            dataType: "json",
    ...
    function clear() {
        ...
        $('.alert-danger').hide();
        $("#divvoucherdate").hide();
        $("#divvoucheramount").hide();
        $("#assignvoucher").removeAttr("checked");
        $("#assignvoucher").parent().removeClass("checked");
    ...
    function ValidateUserInfo() {
        ...
        formap.validate({
            ...
            submitHandler: function (form) {
                ...
                var assignvoucher = $("#assignvoucher").is(":checked");
                ...
                if (password != confirmpassword) {
                    ...
                    $.ajax({
                        url: "MainProfile.aspx/CreateUser",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        data: "{'role':'" + role + "','firstname':'" + firstname + "','lastname':'" + lastname + "','email':'" + email + "','phone':'" + phone + "','username':'" + username + "','password':'" + password + "','Roleid':'" + Roleid + "','clientid':'" + clientid + "','voucheramt':'" + voucheramt + "','voucherdate':'" + voucherdate + "','IsVoucherAssigned':'" + assignvoucher + "'}",
                        dataType: "json",
                        async: false,
    ...
    $("#assignvoucher").click(function () {

        if ($('#assignvoucher').is(":checked"))
        {
            $("#divvoucheramount").show();
            $("#divvoucherdate").show()
        }
        else {
    ...
    $('.make-switch').on('switchChange.bootstrapSwitch', function (event, state) {
        ...
        $.ajax({
            url: "MainProfile.aspx/ActiveInactiveUser",
    ...
    $("#username").focusout(function () {
        ...
        $.ajax({
            url: "MainProfile.aspx/CheckUser",
            type: "POST",
            contentType: "application/json; charset=utf-8",
    ...
    $("#btnchangerole").click(function () {
        ...
        $.ajax({
            url: "MainProfile.aspx/ChangeRole",
            type: "POST",
            contentType: "application/json; charset=utf-8",
